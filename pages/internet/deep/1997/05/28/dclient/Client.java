//
// Client - the client side object manager and server connection maintainer
//
...
public class Client implements Runnable, DObjectManager
{
    ...
    public void run ()
    {
        while (_dispatcher == Thread.currentThread()) {
            try {
                ...
                System.err.println("Lost event connection to server.");
                disconnect();
         ...
         throws IOException
    {
        ...
        if (sub != null) dmo.addSubscriber(sub);
