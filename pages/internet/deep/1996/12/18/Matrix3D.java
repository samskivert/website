// Matrix3D
// modified from Sun class distributed with JDK.
// see license below.
...
public class Matrix3D {
	...
	/**
	 * transform each vertex into its screen coordinates.
	 */
    void transform(Vertex[] v) {
		for (int ii = 0; ii < v.length; ii++) {
			...
			float y = v[ii].y;
			float z = v[ii].z;
			v[ii].screenX = (int) (x * xx + y * xy + z * xz + xo);
			v[ii].screenY = (int) (x * yx + y * yy + z * yz + yo);
			v[ii].screenZ = (int) (x * zx + y * zy + z * zz + zo);
		}
    }
